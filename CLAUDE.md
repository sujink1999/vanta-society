...
- `app/(tabs)/` - Tab-based navigation group (Winter Arc, Community, Tools)
...
- Colors: `bg-vanta-primary`, `text-text-primary`, `text-text-secondary`, `bg-vanta-black`
- Fonts: `font-tussi-bold`, `font-mont`, `font-tussi-heavy`, etc.
...
**Usage Pattern:**
```tsx
import { googleSignIn, getProfile, getTodaysTasks, completeTask } from '@/services/api';
